...
func TestReaderValueOrPanic(t *testing.T) {
	t.Run("returns value when present", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_PANIC")
	...
	t.Run("panics when missing", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_PANIC_MISSING")
	...
	t.Run("panics on error", func(t *testing.T) {
		...
		reader := envutil.Int[int](t.Context(), "TEST_PANIC_ERROR")
...
func TestReaderValueOrElse(t *testing.T) {
	t.Run("returns value when present", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_OR_ELSE")
	...
	t.Run("returns default when missing", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_OR_ELSE_MISSING")
		value := reader.ValueOrElse("default")
	...
	t.Run("returns default on error", func(t *testing.T) {
		...
		reader := envutil.Int[int](t.Context(), "TEST_OR_ELSE_ERROR")
...
func TestReaderValueOrElseFunc(t *testing.T) {
	t.Run("returns value when present", func(t *testing.T) {
		...
		called := false
		reader := envutil.String(t.Context(), "TEST_OR_ELSE_FUNC")
	...
	t.Run("calls function when missing", func(t *testing.T) {
		...
		called := false
		reader := envutil.String(t.Context(), "TEST_OR_ELSE_FUNC_MISSING")
		value := reader.ValueOrElseFunc(func() string {
			called = true
...
func TestReaderValueOrElseFuncErr(t *testing.T) {
	t.Run("returns value when present", func(t *testing.T) {
		...
		called := false
		reader := envutil.String(t.Context(), "TEST_OR_ELSE_FUNC_ERR")
	...
	t.Run("calls function when missing", func(t *testing.T) {
		...
		called := false
		reader := envutil.String(t.Context(), "TEST_OR_ELSE_FUNC_ERR_MISSING")
		value, err := reader.ValueOrElseFuncErr(func() (string, error) {
			called = true
	...
	t.Run("returns error from function", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_OR_ELSE_FUNC_ERR_MISSING2")
...
func TestReaderDoWithValue(t *testing.T) {
	t.Run("calls function when present", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_DO_WITH")
	...
	t.Run("does not call function when missing", func(t *testing.T) {
		...
		called := false
		reader := envutil.String(t.Context(), "TEST_DO_WITH_MISSING")
		reader.DoWithValue(func(v string) {
			called = true
		})
		assert.False(t, called)
	...
	t.Run("does not call function on error", func(t *testing.T) {
		...
		called := false
		reader := envutil.Int[int](t.Context(), "TEST_DO_WITH_ERROR")
...
func TestReaderHasValue(t *testing.T) {
	t.Run("true when present", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_HAS_VALUE")
	...
	t.Run("false when missing", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_HAS_VALUE_MISSING")
	...
	t.Run("false on error", func(t *testing.T) {
		...
		reader := envutil.Int[int](t.Context(), "TEST_HAS_VALUE_ERROR")
		assert.False(t, reader.HasValue())
	})
}
...
func TestReaderHasError(t *testing.T) {
	t.Run("false when valid", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_HAS_ERROR")
	...
	t.Run("false when missing", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_HAS_ERROR_MISSING")
		assert.False(t, reader.HasError())
	})
	...
	t.Run("true on parse error", func(t *testing.T) {
		...
		reader := envutil.Int[int](t.Context(), "TEST_HAS_ERROR_INVALID")
...
func TestReaderString(t *testing.T) {
	t.Run("with value", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_STRING_METHOD")
		str := reader.String()
	...
	t.Run("without value", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_STRING_METHOD_MISSING")
		str := reader.String()
	...
	t.Run("with error", func(t *testing.T) {
		...
		reader := envutil.Int[int](t.Context(), "TEST_STRING_METHOD_ERROR")
		str := reader.String()
...
func TestReaderKey(t *testing.T) {
	...
	reader := envutil.String(t.Context(), "TEST_KEY_METHOD")
...
func TestReaderError(t *testing.T) {
	t.Run("no error when valid", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_ERROR_METHOD")
	...
	t.Run("error when invalid", func(t *testing.T) {
		...
		reader := envutil.Int[int](t.Context(), "TEST_ERROR_METHOD_INVALID")
...
func TestReaderWithErrorIfMissing(t *testing.T) {
	t.Run("adds error when missing", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_WITH_ERROR_MISSING")
	...
	t.Run("preserves value when present", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_WITH_ERROR_PRESENT")
		readerWithErr := reader.WithErrorIfMissing(assert.AnError)
	...
	t.Run("preserves existing error", func(t *testing.T) {
		...
		reader := envutil.Int[int](t.Context(), "TEST_WITH_ERROR_EXISTING")
		readerWithErr := reader.WithErrorIfMissing(assert.AnError)
...
func TestReaderWithDefault(t *testing.T) {
	t.Run("uses default when missing", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_WITH_DEFAULT_MISSING")
	...
	t.Run("preserves value when present", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_WITH_DEFAULT_PRESENT")
		readerWithDefault := reader.WithDefault("default")
...
func TestReaderWithFallback(t *testing.T) {
	t.Run("uses fallback when missing", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_WITH_FALLBACK_A")
		fallback := envutil.String(t.Context(), "TEST_WITH_FALLBACK_B")
	...
	t.Run("preserves value when present", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_WITH_FALLBACK_PRIMARY")
		fallback := envutil.String(t.Context(), "TEST_WITH_FALLBACK_SECONDARY")
		readerWithFallback := reader.WithFallback(fallback)
...
func TestReaderMap(t *testing.T) {
	t.Run("transforms value", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_MAP")
	...
	t.Run("propagates error from map function", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_MAP_ERROR")
		mapped := reader.Map(func(s string) (string, error) {
			return "", assert.AnError
		})
	...
	t.Run("skips map when value missing", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_MAP_MISSING")
		mapped := reader.Map(func(s string) (string, error) {
...
func TestMapFunction(t *testing.T) {
	t.Run("transforms type A to B", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_MAP_FUNC")
	...
	t.Run("preserves missing state", func(t *testing.T) {
		...
		reader := envutil.String(t.Context(), "TEST_MAP_FUNC_MISSING")
		mapped := envutil.Map(reader, func(s string) (int, error) {
			t.Fatal("map function should not be called")
	...
	t.Run("preserves error state", func(t *testing.T) {
		...
		reader := envutil.Int[int](t.Context(), "TEST_MAP_FUNC_ERROR")
