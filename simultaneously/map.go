...
func MapGoMapCtx[InKey comparable, InVal any, OutKey comparable, OutVal any](
	...
	out, err := MapMapCtx[maps.Key[InKey], InVal, maps.Key[OutKey], OutVal](ctx, maxConcurrent, in,
...
func FlatMapGoMapCtx[InKey comparable, InVal any, OutKey comparable, OutVal any](
	...
	out, err := FlatMapMapCtx[maps.Key[InKey], InVal, maps.Key[OutKey], OutVal](ctx, maxConcurrent, in,
