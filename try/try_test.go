...
func TestTry_IsSuccess(t *testing.T) {
	...
	t.Run("returns true when Error is nil", func(t *testing.T) {
		...
		tr := try.Try[int]{Value: 42, Error: nil}
	...
	t.Run("returns false when Error is not nil", func(t *testing.T) {
		...
		tr := try.Try[int]{Value: 0, Error: errors.New("test error")} //nolint:err113
...
func TestTry_Get(t *testing.T) {
	...
	t.Run("returns value and nil error on success", func(t *testing.T) {
		...
		tr := try.Try[string]{Value: "hello", Error: nil}
		val, err := tr.Get()
	...
	t.Run("returns zero value and error on failure", func(t *testing.T) {
		...
		tr := try.Try[string]{Value: "hello", Error: expectedErr}
		val, err := tr.Get()
	...
	t.Run("returns zero value for complex types on failure", func(t *testing.T) {
		...
		expectedErr := errors.New("test error") //nolint:err113
		tr := try.Try[customType]{Value: customType{Field: "test"}, Error: expectedErr}
		val, err := tr.Get()
...
func TestTry_GetOrElse(t *testing.T) {
	...
	t.Run("returns default value on failure", func(t *testing.T) {
		...
		tr := try.Try[int]{Value: 42, Error: errors.New("test error")} //nolint:err113
		result := tr.GetOrElse(100)
	...
	t.Run("works with string type", func(t *testing.T) {
		...
		tr := try.Try[string]{Value: "", Error: errors.New("test error")} //nolint:err113
...
func TestMap(t *testing.T) {
	...
	t.Run("propagates error from original Try", func(t *testing.T) {
		...
		tr := try.Try[int]{Value: 5, Error: expectedErr}
		result := try.Map(tr, func(v int) (string, error) {
	...
	t.Run("transforms between different types", func(t *testing.T) {
		...
		tr := try.Try[string]{Value: "42", Error: nil}
		result := try.Map(tr, func(v string) (int, error) {
			return 42, nil
		})
...
func TestFlatMap(t *testing.T) {
	...
	t.Run("transforms value on success", func(t *testing.T) {
		...
		tr := try.Try[int]{Value: 5, Error: nil}
		result := try.FlatMap(tr, func(v int) try.Try[string] {
			return try.Try[string]{Value: "Number: 5", Error: nil}
		})
	...
	t.Run("propagates error from original Try", func(t *testing.T) {
		...
		tr := try.Try[int]{Value: 5, Error: expectedErr}
		result := try.FlatMap(tr, func(v int) try.Try[string] {
			return try.Try[string]{Value: "should not be called", Error: nil}
		})
	...
	t.Run("returns failure from transform function", func(t *testing.T) {
		...
		expectedErr := errors.New("transform error") //nolint:err113
		result := try.FlatMap(tr, func(v int) try.Try[string] {
			return try.Try[string]{Value: "", Error: expectedErr}
		})
	...
	t.Run("chains multiple operations", func(t *testing.T) {
		...
		tr := try.Try[int]{Value: 10, Error: nil}

		result := try.FlatMap(tr, func(v int) try.Try[int] {
			return try.Try[int]{Value: v * 2, Error: nil}
		})

		resultStr := try.FlatMap(result, func(v int) try.Try[string] {
			return try.Try[string]{Value: "Result: 20", Error: nil}
		})
	...
	t.Run("stops chain on first error", func(t *testing.T) {
		...
		result := try.FlatMap(tr, func(v int) try.Try[int] {
			return try.Try[int]{Value: 0, Error: expectedErr}
		})
